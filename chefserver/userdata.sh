...
CHEF_SERVER_NAME="FirstChef" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="firstchef-4cqevyczrdik97zz.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
