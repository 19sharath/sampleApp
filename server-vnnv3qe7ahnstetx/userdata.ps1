<powershell>
 ...
 $env:CHEF_SERVER_NAME = "server" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "server-vnnv3qe7ahnstetx.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
