...
CHEF_SERVER_NAME="server" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="server-vnnv3qe7ahnstetx.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
