<powershell>
 ...
 $env:CHEF_SERVER_NAME = "FirstChef" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "firstchef-4cqevyczrdik97zz.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
 ...
 $env:CHEF_CLIENT_VERSION = "12.21.3" # Latest, if left empty
 ...
 $env:CHEF_RUN_LIST="recipe[chef-client]" # E.g. "recipe[chef-client],recipe[apache2]"
